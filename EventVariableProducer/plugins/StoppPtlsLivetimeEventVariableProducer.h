...
class StoppPtlsLivetimeEventVariableProducer : public EventVariableProducer
{
 public:
  StoppPtlsLivetimeEventVariableProducer (const edm::ParameterSet &);
  ~StoppPtlsLivetimeEventVariableProducer ();
