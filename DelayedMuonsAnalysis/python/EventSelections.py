...
DelayedMuonsUpperLowerRemoveDeltaTimeOutIn = copy.deepcopy(DelayedMuonsUpperLowerSelection)
DelayedMuonsUpperLowerRemoveDeltaTimeOutIn.name = cms.string("DelayedMuonsUpperLowerRemoveDeltaTimeOutIn")
removeCuts(DelayedMuonsUpperLowerRemoveDeltaTimeOutIn.cuts,[cutUpperLowerDSADeltaTimeOutIn])
...
removeCuts(DelayedMuonsUpperLowerOnlyThroughTimeOutInErr.cuts,[cutUpperLowerDSADeltaTimeInOut2016])

DelayedMuonsUpperLowerStricterDeltaTimeInOut = copy.deepcopy(DelayedMuonsUpperLowerOnlyThroughTimeOutInErr)
DelayedMuonsUpperLowerStricterDeltaTimeInOut.name = cms.string("DelayedMuonsUpperLowerStricterDeltaTimeInOut")
DelayedMuonsUpperLowerStricterDeltaTimeInOut.cuts.append(cutUpperLowerDSADeltaTimeInOutGreaterThanNeg18)
DelayedMuonsUpperLowerStricterDeltaTimeInOut.cuts.append(cutLowerDSADtTofFreeInverseBeta)

DelayedMuonsUpperLowerMismeasuredDeltaTimeInOut = copy.deepcopy(DelayedMuonsUpperLowerOnlyThroughTimeOutInErr)
DelayedMuonsUpperLowerMismeasuredDeltaTimeInOut.name = cms.string("DelayedMuonsUpperLowerMismeasuredDeltaTimeInOut")
DelayedMuonsUpperLowerMismeasuredDeltaTimeInOut.cuts.append(cutUpperLowerDSADeltaTimeInOutGreaterThanNeg5)
DelayedMuonsUpperLowerMismeasuredDeltaTimeInOut.cuts.append(cutUpperLowerDSADeltaTimeOutInLessThanNeg30)

DelayedMuonsUpperLowerMismeasuredDeltaTimeOutIn = copy.deepcopy(DelayedMuonsUpperLowerOnlyThroughTimeOutInErr)
DelayedMuonsUpperLowerMismeasuredDeltaTimeOutIn.name = cms.string("DelayedMuonsUpperLowerMismeasuredDeltaTimeOutIn")
DelayedMuonsUpperLowerMismeasuredDeltaTimeOutIn.cuts.append(cutUpperLowerDSADeltaTimeInOutLessThanNeg20)
DelayedMuonsUpperLowerMismeasuredDeltaTimeOutIn.cuts.append(cutUpperLowerDSADeltaTimeOutInGreaterThanNeg15)
...
DelayedMuonsUpperLowerSelectionRegionA1B1.cuts.append(cutUpperLowerDSADeltaRpcHitBxAverageGreaterNeg1p5LessNeg0p9)
