...
#        ),
        ...
        cms.PSet (
            inputCollection = cms.vstring ("tracks"),
            valueToPrint = cms.string ("eta")
            ),
        cms.PSet (
            inputCollection = cms.vstring ("tracks"),
            valueToPrint = cms.string ("phi")
            ),
        cms.PSet (
            inputCollection = cms.vstring ("tracks"),
            valueToPrint = cms.string ("dtTofTimeAtIpInOut")
            ),
        cms.PSet (
            inputCollection = cms.vstring ("tracks"),
            valueToPrint = cms.string ("rpcHitBxAverage")
            ),
    ),
