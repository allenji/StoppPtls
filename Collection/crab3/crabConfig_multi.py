...
config.JobType.psetName = '../python/stoppPtlsCandidate_Master_cfg.py'
...
if __name__ == '__main__':
    ...
    for dataset in [ '/NoBPTX/Run2015D-PromptReco-v4/RECO']:
        config.Data.inputDataset = dataset
        config.General.requestName = dataset.split('/')[2]+'_OSUT3Frmwrk_Jan25_2'
       # crabCommand('submit', config = config)
