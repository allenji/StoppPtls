...
process.source = cms.Source ("PoolSource",
        ...
        'file:HSCPmchamp6_M_2200_TuneZ2star_13TeV_pythia6_cff_GEN_SIM.root'
        )
                             )
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
                                        ...
                                        fileName = cms.untracked.string("HSCPmchamp6_M_2200_TuneZ2star_13TeV_pythia6_cff_GEN_SIM_StoppedEventFilter.root"),
...
process.generator = cms.EDProducer("Pythia6HSCPGun",
                                   ...
                                   PGunParameters = cms.PSet(MinPhi = cms.double(-3.14159265359),
                                                             ...
                                                             decayTable = cms.string('../../../stage2ParticlesTable_mchamp2200.txt') #for interactive:  where you do cmsenv
                                                             ),
                                   ...
                                   PythiaParameters = cms.PSet( processParameters = cms.vstring('IMSS(1)=11          ! User defined processes',
                                                                ...
                                                                parameterSets = cms.vstring('processParameters',
                                                                                            'SLHAParameters'),
                                                                SLHAParameters = cms.vstring('SLHAFILE=stage2ParticlesTable_mchamp2200.txt')
                                                                )
                                   )
