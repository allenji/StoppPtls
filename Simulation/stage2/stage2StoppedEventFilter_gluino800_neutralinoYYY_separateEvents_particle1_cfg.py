...
process.source = cms.Source ("PoolSource",
        ...
        'file:HSCPmchamp6_M_800_TuneZ2star_13TeV_pythia6_cff_GEN_SIM.root'
        )
                             )
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
                                        ...
                                        fileName = cms.untracked.string("HSCPgluino800_neutralinoYYY_separateEvents_particle0_StoppedEventFilter.root"),
...
process.generator = cms.EDProducer("Pythia6HSCPGun",
                                   ...
                                   PGunParameters = cms.PSet(MinPhi = cms.double(-3.14159265359),
                                                             ...
                                                             decayTable = cms.string('../../../stage2ParticlesTable_gluino800.txt') #for interactive:  where you do cmsenv
                                                             ),
        ...
        processParameters = cms.vstring('IMSS(1)=11          ! User defined processes',
                                        ...
                                        'MDME(138,1)= 0       ! tau decay to whatever     '                                        
                                                                ...
                                                                parameterSets = cms.vstring('processParameters',
                                                                                            'SLHAParameters'),
                                                                SLHAParameters = cms.vstring('SLHAFILE=stage2ParticlesTable_gluino800.txt')
                                                                )
                                   )
