...
#Gluino counting
x_G200 = [50, 100, 150, 180]
count_G200 = [11., 1270., 2330., 2500.]
total_G200 = [5390.] * len(x_G200)
x_G600 = [float(i) for i in range(50, 750, 50)]
count_G600 = [18., 1730., 2690., 2820., 2930., 2870., 2950., 2870., 2860., 2810., 2810., 2720., 2640., 2670.]
total_G600 = [5110.] * len(x_G600)

x_G1200 = [float(i) for i in range(50, 950, 50)]
count_G1200 = [17., 1880., 2820., 3110., 3100., 3150., 3110., 3020., 3050., 2970., 2910., 2920., 2890., 2840., 2770., 2680., 2640., 2580.]
total_G1200 = [5430.] * len(x_G1200)

x_G1800 = [75.,100.,125.,175.,225.,275.,325.,375., 425., 475.]
count_G1800 = [812., 2180., 3000., 3500., 3560., 3590., 3650., 3520., 3530., 3460.]
total_G1800 = [6250.] * len(x_G1800)
...
y_G200, err_G200, y_G600, err_G600, y_G1200, err_G1200, y_G1800, err_G1800 = [], [], [], [], [], [], [], []
for i in range(len(x_G200)):
    y_G200.append(count_G200[i]/total_G200[i])
    err_G200.append(y_G200[i] * rt.TMath.Sqrt(1./count_G200[i] + 1./total_G200[i]))
...
graph_G200 = rt.TGraphErrors(len(x_G200), convert_to_array(x_G200), convert_to_array(y_G200), 
                             convert_to_array(len(x_G200)*[0]), convert_to_array(err_G200))
...
graph_Gluino.SetTitle(";m_{#tilde{g}} - m_{#tilde{#chi}^{0}} [GeV];#varepsilon_{reco}")
...
graph_Gluino.GetXaxis().SetLimits(40, 470)
graph_Gluino.Draw("AP")
graph_GluinoPlus.Draw("P same")
graph_GluinoMinus.Draw("P same")

graph_G200.SetLineColor(rt.kRed)
graph_G200.SetMarkerColor(rt.kRed)
graph_G200.SetMarkerStyle(23)
graph_G200.SetMarkerSize(1.15)
graph_G200.SetLineWidth(2)
...
fit_Gluino = rt.TF1("gfit", "[0]*TMath::Erf([1]*x-[2])+[3]", 0, 470)
fit_Gluino.SetParameters(0.25,0.034,2.33,0.25)
fit_GluinoPlus = rt.TF1("gfitp", "[0]*TMath::Erf([1]*x-[2])+[3]", 0, 470)
...
fit_GluinoMinus = rt.TF1("gfitm", "[0]*TMath::Erf([1]*x-[2])+[3]", 0, 470)
...
#graph_G200.Draw("P same")
graph_G600.Draw("P same")
graph_G1200.Draw("P same")
graph_G1800.Draw("P same")

graph_Gluino.Fit(fit_Gluino, "", "", 0, 470)
graph_GluinoPlus.Fit(fit_GluinoPlus, "", "", 0, 470)
graph_GluinoMinus.Fit(fit_GluinoMinus, "", "", 0, 470)
...
#legend.AddEntry(graph_G200, "#tilde{g} #rightarrow q#bar{q}#tilde{#chi}^{0}, m_{#tilde{g}} = 200 GeV","ep")
legend.AddEntry(graph_G600, "#tilde{g} #rightarrow q#bar{q}#tilde{#chi}^{0}, m_{#tilde{g}} = 800 GeV","ep")
legend.AddEntry(graph_G1200, "#tilde{g} #rightarrow q#bar{q}#tilde{#chi}^{0}, m_{#tilde{g}} = 1000 GeV","ep")
legend.AddEntry(graph_G1800, "#tilde{g} #rightarrow q#bar{q}#tilde{#chi}^{0}, m_{#tilde{g}} = 1800 GeV","ep")
...
canvas.Write()
canvas.Print("energyscan_fit_13TeV_2016Simulation_3BDecay_CWR.pdf")
outputfile.Close()
