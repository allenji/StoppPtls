...
process.source = cms.Source ("PoolSource",
                             fileNames = cms.untracked.vstring (
                               'file:/home/weifengji/StoppedParticles_Run2/AnalysisFramework_Dev/CMSSW_7_4_5_ROOT5/src/StoppPtls/Collection/python/RECOWithStoppedParticleEvents_MC_g2qqchi_1200_1000.root',
        ),
)
...
process.TFileService = cms.Service ('TFileService',
    fileName = cms.string ('g2qqchi_1200_1000.root')
)
...
add_channels (process, [NoCuts], cms.VPSet (NumberOfObjectsHistograms,LeadingJetHistograms,SecondJetHistograms), weights, collectionMap_Custom, variableProducers)
