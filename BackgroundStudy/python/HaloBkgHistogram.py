...
HaloBackgroundHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
      cms.PSet (
        ...
        inputVariables = cms.vstring("meanCscXNearJetDeltaPhi0p2", "meanCscYNearJetDeltaPhi0p2"),
      ),
      cms.PSet (
        ...
        inputVariables = cms.vstring("meanCscRNearJetDeltaPhi0p2", "meanCscPhiNearJetDeltaPhi0p2"),
      )
    )
)
