...
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/makeFinalPlots.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/makeExtraPlots.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/finalPlotStyle.C $dataset/.

cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/LimitPlots.h $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/LimitPlots.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/ExtraLimitPlots.h $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/ExtraLimitPlots.C $dataset/.

cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/modelIndLimit.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/gluinoLimit.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/stopLimit.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/massPlot.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/gluinoMass.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/stopMass.C   $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/data/mcGluino.txt $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/data/mcStop.txt $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/data/mcStau.txt $dataset/.

cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/allInOneLifetime.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/gluinostopMassLifetime.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/excludedRegion.C $dataset/.
cp $CMSSW_BASE/src/StoppPtls/ToyMC/macros/excludedRegionStop.C $dataset/.
